app.controller('ListeFormateursController',function($scope,$http,apiUrl,CurrentUser,Notification,$window,$rootScope,$location){
    /***************************************************************************************************
     ***************************************** Start Controller ****************************************
     *************************************************************************************************** */
    ...
    $scope.Edit = function (id){
        $location.path('GestionDonnees/ModifFormateurs/'+id);
    }
    ...
    $scope.Delete = function (id){
        swal({
            ...
            if (isConfirm) {
                ...
                $http({
                    method: 'DELETE',
                    url: apiUrl + 'FormaCampAPI/Formateurs/'+id,
                    headers: {'Content-Type': undefined}
                }).then(function (response) {
