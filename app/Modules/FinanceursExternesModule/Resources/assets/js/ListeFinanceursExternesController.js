app.controller('ListeFinanceursExternesController',function($scope,$http,apiUrl,CurrentUser,Notification,$window,$rootScope,$location){
    /***************************************************************************************************
     ***************************************** Start Controller ****************************************
     *************************************************************************************************** */
    ...
    $scope.Edit = function (id){
        $location.path('GestionDonnees/ModifFinanceursExternes/'+id);
    }
    /**
     * data list function
     * */
    ...
    $scope.Delete = function (id){
        swal({
            ...
            if (isConfirm) {
                $http({
                    method: 'DELETE',
                    url: apiUrl + 'FormaCampAPI/FinanceursExternes/'+id,
                    headers: {'Content-Type': undefined}
                }).then(function (response) {
