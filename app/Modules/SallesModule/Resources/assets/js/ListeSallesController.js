app.controller('ListeSallesController',function($scope,$http,apiUrl,CurrentUser,Notification,$window,$rootScope,$location,$uibModal,$routeParams){
    /***************************************************************************************************
     ***************************************** Start Controller ****************************************
     *************************************************************************************************** */
    /**
    ...
    $scope.Add = function (){
        $scope.modalInstance = $uibModal.open({
            templateUrl: apiUrl + 'app/Modules/SallesModule/Resources/views/popup_salle.html',
            windowClass: 'medium',
            scope: $scope,
            resolve: {
                title: function () {
    ...
    $scope.Edit = function (id){
        $http({
            method: 'GET',
            url: apiUrl + 'FormaCampAPI/Salles/'+id,
            headers: {'Content-Type': undefined}
        }).then(function (response) {
            $scope.modalInstance = $uibModal.open({
                templateUrl: apiUrl + 'app/Modules/SallesModule/Resources/views/popup_salle.html',
    ...
    $scope.Save = function (){
        ...
        if($scope.ins.ID_SALLE != undefined){
            form_data.append('_method' , 'PUT')
            var api = 'FormaCampAPI/Salles/'+$scope.ins.ID_SALLE;
        }else{
            var api = 'FormaCampAPI/Salles';
        }
