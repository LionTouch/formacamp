app.controller('ListeActionsController',function($scope,$http,apiUrl,CurrentUser,Notification,$window,$rootScope,$location,$uibModal,$routeParams){
    /***************************************************************************************************
     ***************************************** Start Controller ****************************************
     *************************************************************************************************** */
    /**
    ...
    $scope.Add = function (){
        $scope.modalInstance = $uibModal.open({
            templateUrl: apiUrl + 'app/Modules/ActionsFormationModule/Resources/views/popup_action.html',
            windowClass: 'medium',
            scope: $scope,
            resolve: {
                title: function () {
    ...
    $scope.Edit = function (id){
        $http({
            method: 'GET',
            url: apiUrl + 'FormaCampAPI/Actions/'+id,
            headers: {'Content-Type': undefined}
        }).then(function (response) {
            $scope.modalInstance = $uibModal.open({
                templateUrl: apiUrl + 'app/Modules/ActionsFormationModule/Resources/views/popup_action.html',
    ...
    $scope.Save = function (){
        ...
        if($scope.ins.ID_ACTION != undefined){
            form_data.append('_method' , 'PUT')
            var api = 'FormaCampAPI/Actions/'+$scope.ins.ID_ACTION;
        }else{
            var api = 'FormaCampAPI/Actions';
        }
