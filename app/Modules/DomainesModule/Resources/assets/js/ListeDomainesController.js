app.controller('ListeDomainesController',function($scope,$http,apiUrl,CurrentUser,Notification,$window,$rootScope,$location,$uibModal,$routeParams){
    /***************************************************************************************************
     ***************************************** Start Controller ****************************************
     *************************************************************************************************** */
    /**
    ...
    $scope.Add = function (){
        $scope.modalInstance = $uibModal.open({
            templateUrl: apiUrl + 'app/Modules/DomainesModule/Resources/views/popup_domaine.html',
            windowClass: 'medium',
            scope: $scope,
            resolve: {
                title: function () {
    ...
    $scope.Edit = function (id){
        $http({
            method: 'GET',
            url: apiUrl + 'FormaCampAPI/Domaines/'+id,
            headers: {'Content-Type': undefined}
        }).then(function (response) {
            $scope.modalInstance = $uibModal.open({
                templateUrl: apiUrl + 'app/Modules/DomainesModule/Resources/views/popup_domaine.html',
    ...
    $scope.Save = function (){
        ...
        if($scope.ins.ID_DOMAINE != undefined){
            form_data.append('_method' , 'PUT')
            var api = 'FormaCampAPI/Domaines/'+$scope.ins.ID_DOMAINE;
        }else{
            var api = 'FormaCampAPI/Domaines';
        }
