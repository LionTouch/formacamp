                    ...
                    <form  method="POST" action="<?php echo e(route('login')); ?>" class="mt-4">
						...
						<div class="form-group">
							<div class="d-inline-block w-100">
								<button type="submit" class="btn btn-primary col-lg-12"><?php echo e(__('Connexion')); ?></button>
							</div>
							<div class="d-inline-block w-100">
								<div class="text-grey-5" style="text-align:center">Vous êtes nouveau ? <a href="<?php echo e(route('register')); ?>" class="text-2">Inscription</a></div>
							</div>
                        </div>
                    </form>
                </div>
...
<?php /**PATH /var/www/html/formacamp/resources/views/auth/login.blade.php ENDPATH**/ ?>